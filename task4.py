...
if profit > costs:
    print(f'Фирма работает с прибылью. Рентабельность  составила {(profit - costs) / profit:.2f}')
    workers = int(input('Введите количество сотрудников фирмы '))
    print(f'прибыль из расчета на одного сторудника: {(profit - costs) / workers:.2f}')
elif profit == costs:
    print('Фирма работает в ноль')
else:
    print('Убытки. Меняем директора')
